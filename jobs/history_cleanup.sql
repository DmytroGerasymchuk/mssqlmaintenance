...
declare @JobName sysname = N'$(MaintDBName): History Cleanup'
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'proceed', 
		...
		@command=N'execute $(MaintDBName).maint.usp_history_cleanup', 
		@database_name=N'master', 
		@output_file_name=N'$(JobLogDir)\history-cleanup.txt', 
		@flags=4
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
