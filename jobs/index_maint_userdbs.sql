...
declare @JobName sysname = N'$(MaintDBName): Index Maintenance (User DBs)'
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'proceed', 
		...
		@command=N'execute $(MaintDBName).maint.usp_index_maint ''*user''', 
		@database_name=N'master', 
		@output_file_name=N'$(JobLogDir)\index-maint-user-dbs.txt', 
		@flags=4
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
