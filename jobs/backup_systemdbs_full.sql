...
declare @JobName sysname = N'$(MaintDBName): Backup: System DBs: Full'
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'backup', 
		...
		@command=N'execute $(MaintDBName).maint.usp_backup ''*system''', 
		@database_name=N'master', 
		@output_file_name=N'$(JobLogDir)\backup-system-dbs-full.txt', 
		@flags=4
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
